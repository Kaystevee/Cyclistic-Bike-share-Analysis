-- STEP 1: SELECT ALL THE MONTHLY SEPERATE DATA AND JOIN THEM ALL USING "UNION ALL"
SELECT *
...
-- STEP 2:CREATE AN EMPTY "bikedata2022" TABLE WITH THE SAME STRUCTURE AS "jan2022"
SELECT *
INTO bikedata2022
FROM PortfolioProject..jan2022
WHERE 1 = 0;

-- STEP 3: IMPORT ALL THE SEPERATE MONTHLY DATA INTO THE "bikedata2022" TABLE
...
-- STEP 4: CONFIRM THAT THE DATA HAS BEEN SUCCESSFULLY MERGED
...
-- STEP 5:ADD A NEW COLUMN NAMED "ride_length" TO THE "bikedata2022" TABLE
...
--STEP 6:ADD A NEW COLUMN "day_of_week" THAT SHOWS THE WEEKDAYS 
...
--STEP 7:CHECK FOR DUPLICATE DATA, AND DELETE IF THERE IS ANY
...
--STEP 8: TOTAL NUMBER OF RIDES
SELECT COUNT(*) AS TotalRide
FROM PortfolioProject..bikedata2022;

--STEP 9: THE AVERAGE RIDE LENGTH

SELECT AVG(ride_length) AS avg_ride_length
FROM PortfolioProject..bikedata2022;

--STEP 10: MAXIMUM RIDE LENGTH FOR ALL THE CUSTORMERS

SELECT MAX(ride_length) AS max_ride_length
FROM PortfolioProject..bikedata2022;

--  STEP 11: THE HOURLY RIDE COUNT
...
--STEP 13: THE MONTHLY RIDE COUNT
...
--STEP 14: AVERAGE RIDE LENGHT FOR SEPERATE USERS BY WEEKDAYS
...
-- STEP 15: TOTAL NUMBER OF RIDES BY USERS

SELECT member_casual, COUNT(*) AS total_rides
FROM PortfolioProject..bikedata2022
GROUP BY member_casual;

--STEP 16: TOTAL NUMBER OF RIDE COUNT BY BIKE TYPE
...
--CREAT VIEWS TO STORE DATA FOR VISUALIZATION 
